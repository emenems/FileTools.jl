...
function test_loadatmacs()
	...
	# Independent loading
	glo_m = readdlm(joinpath(dirname(@__DIR__),"test","input","atmacs_glo.grav"))
	loc_m = readdlm(joinpath(dirname(@__DIR__),"test","input","atmacs_loc.grav"))
	...
	gfiles=[joinpath(dirname(@__DIR__),"test","input","atmacs_all_1.grav"),
			joinpath(dirname(@__DIR__),"test","input","atmacs_all_2.grav"),
			joinpath(dirname(@__DIR__),"test","input","atmacs_all_3.grav")];
